-- Chainlit data-layer schema (ChainlitDataLayer, activated by DATABASE_URL).
-- Source: github.com/Chainlit/chainlit-datalayer prisma migrations
--   20250103173917_init_data_layer + 20250108095538_add_tags_to_thread
-- Runs once on first Postgres init via /docker-entrypoint-initdb.d/.
-- The agent's own agent_sessions/agent_messages tables are created separately
-- by the Agents SDK and are unaffected by this file.
